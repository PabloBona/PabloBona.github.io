...
const invitedData = [
  {
    ...
    hobbies:
      'As the new winner of the Air Fried Chicken Contest, Elena promotes now a healthy cook.',
  ...
  },
  {
    ...
    hobbies:
      'Passionate about creating unique flavors and exploring culinary traditions from around the world.',
  ...
  },
  {
    ...
    hobbies:
      'Enjoys experimenting with new ingredients and sharing her creations on social media.',
  ...
  },
  {
    ...
    hobbies:
      'Dedicated to preserving traditional cooking techniques and flavors through his innovative menus.',
  ...
  },
  {
    ...
    hobbies:
      'Passionate about helping others achieve optimal health through balanced nutrition and lifestyle choices.',
  ...
  },
  {
    ...
    hobbies:
      'Specializes in creating delectable desserts with a creative twist and unique flavor combinations.',
